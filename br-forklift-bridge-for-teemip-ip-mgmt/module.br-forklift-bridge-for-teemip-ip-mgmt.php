...
SetupWebPage::AddModule(
    __FILE__,
    'br-forklift-bridge-for-teemip-ip-mgmt/2.7.1',
    array(
        // Identification
        //
        ...
        'dependencies' => array(
            ...
            'br-forklift/2.7.1||teemip-ip-mgmt/3.0.0',
            'br-forklift/2.7.1||teemip-config-mgmt-adaptor/3.0.0',
            'br-forklift/2.7.1',
        ),
        'mandatory' => false,
        ...
        //
        'datamodel' => array(
            'model.br-forklift-bridge-for-teemip-ip-mgmt.php',
        ),
        'data.struct' => array(),
        'data.sample' => array(),
